...
namespace MyApp.OpenAi.Moderations {
    ...
    /// </summary>
    public class ModerationsRequestBuilder {
        ...
        public ModerationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/moderations";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ModerationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
