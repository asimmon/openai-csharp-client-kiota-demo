...
namespace MyApp.OpenAi.Embeddings {
    ...
    /// </summary>
    public class EmbeddingsRequestBuilder {
        ...
        public EmbeddingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/embeddings";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmbeddingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
