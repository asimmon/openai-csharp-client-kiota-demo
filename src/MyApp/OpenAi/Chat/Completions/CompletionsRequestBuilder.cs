...
namespace MyApp.OpenAi.Chat.Completions {
    ...
    /// </summary>
    public class CompletionsRequestBuilder {
        ...
        public CompletionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompletionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
