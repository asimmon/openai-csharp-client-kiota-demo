...
namespace MyApp.OpenAi.Files.Item {
    ...
    /// </summary>
    public class WithFile_ItemRequestBuilder {
        ...
        public WithFile_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/files/{file_id}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithFile_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
