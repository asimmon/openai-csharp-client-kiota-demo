...
namespace MyApp.OpenAi.FineTunes {
    ...
    /// </summary>
    public class FineTunesRequestBuilder {
        ...
        public FineTunesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/fine-tunes";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FineTunesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
