...
namespace MyApp.OpenAi.Images.Variations {
    ...
    /// </summary>
    public class VariationsRequestBuilder {
        ...
        public VariationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/images/variations";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VariationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
