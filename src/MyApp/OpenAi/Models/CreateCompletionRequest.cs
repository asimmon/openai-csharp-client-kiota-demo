...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Completions? Prompt { get; set; }
#nullable restore
#else
        public Completions Prompt { get; set; }
#endif
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"prompt", n => { Prompt = n.GetObjectValue<Completions>(Completions.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Completions>("prompt", Prompt);
        ...
        public class Completions : IAdditionalDataHolder, IParsable {
            /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
            public IDictionary<string, object> AdditionalData { get; set; }
            /// <summary>Composed type representation for type completionsMember1</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public MyApp.OpenAi.Models.CompletionsMember1? CompletionsMember1 { get; set; }
#nullable restore
#else
            public MyApp.OpenAi.Models.CompletionsMember1 CompletionsMember1 { get; set; }
#endif
...
#nullable restore
            ...
            public static Completions CreateFromDiscriminatorValue(IParseNode parseNode) {
                ...
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase)) {
                    result.CompletionsMember1 = new MyApp.OpenAi.Models.CompletionsMember1();
                }
            ...
            /// </summary>
            public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
                if(CompletionsMember1 != null) {
                    return CompletionsMember1.GetFieldDeserializers();
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                _ = writer ?? throw new ArgumentNullException(nameof(writer));
                if(CompletionsMember1 != null) {
                    writer.WriteObjectValue<MyApp.OpenAi.Models.CompletionsMember1>(null, CompletionsMember1);
                }
