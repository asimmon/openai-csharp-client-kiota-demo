...
namespace MyApp.OpenAi.Models {
    public class CreateCompletionResponse_usage : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new CreateCompletionResponse_usage and sets the default values.
        /// </summary>
        public CreateCompletionResponse_usage() {
        ...
        public static CreateCompletionResponse_usage CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CreateCompletionResponse_usage();
        }
        /// <summary>
